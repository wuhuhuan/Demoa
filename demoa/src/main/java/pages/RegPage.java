...
public class RegPage {
	...
	public RegPage regSendContent(String FirstName,String LastName
			...
			,String Line1,String CountryId,String passwords){
		this.sendFirstName(FirstName).sendLastName(LastName).sendDob(Dob).selectGender(Gender).selectCountry(CountryId)
		.selectHelpLanguage(helpLanguage).sendEmail(Email).sendContactNumber(PrimaryContactNumber)
		.sendLine1(Line1).selectCountryId(CountryId).sendPassword(passwords);
